import { state, style, animate, animation, keyframes } from "@angular/animations";
...
export const blurIn = animation([
  animate('{{time}} 0ms cubic-bezier(0.785, 0.135, 0.15, 0.86)', style({
...
export const slideIn = animation([
  ...
  animate('{{time}} cubic-bezier(0.785, 0.135, 0.15, 0.86)', style({
