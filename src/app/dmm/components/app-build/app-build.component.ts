...
import { Block, Coordinates, Molecule, TargetFilter } from 'app/models';

import { BlockService } from 'app/dmm/services/block.service';
import { DroppableEvent } from 'app/dmm/drag-drop-utilities/droppable/droppable.service';
import { WorkspaceService } from 'app/dmm/services/workspace.service';
import { CartService } from 'app/dmm/services/cart.service';
import {
  BLOCK_HEIGHT,
  BLOCK_PADDING_X,
  BLOCK_WIDTH,
} from 'app/dmm/components/block-svg/block-svg.component';
...
export class AppBuildComponent implements OnInit {
  ...
  moleculeTrackBy: TrackByFunction<Molecule> = (index, molecule) => molecule.id;
